...
export default class RegisterVerify extends React.Component {
  state= {
    code: '',
    passphrase: ''
  }
    ...
    render() {
        return (
          <View style={styles.container}>
                ...
                />
                <TouchableOpacity style={styles.greenButton} onPress={() => this.props.navigation.navigate('Passphrase')}>
