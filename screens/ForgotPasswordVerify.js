...
export default class ForgotPasswordVerify extends React.Component {
  state= {
    code: '',
    passphrase: ''
  }
        ...
        return (
          <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={{fontSize: 15, color: '#FFF'}}>Enter confirmation code sent to your email</Text>
                </View>
                <TextInput 
                    style={styles.input}
                ...
                />
                <TouchableOpacity style={styles.greenButton} onPress={() => this.props.navigation.navigate('ForgotPasswordChange')}>
